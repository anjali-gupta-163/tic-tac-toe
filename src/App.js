...
class App extends React.Component {
  ...
  handleModeChange(e) {
    ...
    if (e.target.getAttribute("href").includes("AI")) {
      ...
      document.querySelector("#modeText").textContent = "You have selected AI mode";
      document.querySelector("#twop").style.background = "none";
      document.querySelector("#withAI").style.display = "none";
      document.querySelector("#withFriends").style.display = "block";
      this.setState({ mode: "AI" });
      this.handleReset(null);
    } else if (e.target.getAttribute("href").includes("2P")) {
      // e.target.style.background = "#d4edda";
      document.querySelector("#modeText").textContent = "You have selected Friends mode";
      document.querySelector("#ai").style.background = "none";
      document.querySelector("#withAI").style.display = "block";
      document.querySelector("#withFriends").style.display = "none";
    ...
    return (
      <div>
        <div class="container jumbotron" id="container">
          ...
          <div>
            <p id="modeText">Choose your play mode</p>
            <div className="col customMargin" id="withAI">
              <button className="btn btn-primary toeButtons">
                <a href="./?AI" onClick={this.handleModeChange} id="ai">
                  with AI
                </a>
              </button>
            </div>
            <div className="col customMargin" id="withFriends">
              <button className="btn btn-secondary toeButtons">
                <a href="./?2P" onClick={this.handleModeChange} id="twop">
                  with friends
                </a>
              </button>
            </div>
            <div className="col customMargin" id="reset">
              <button className="btn btn-success toeButtons">
